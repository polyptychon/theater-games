...
function reset_timer() { total_seconds = 30; $("#clock").html("00:30").removeClass("last_ten"); }
...
$.fn.extend({ 
	titlesBehaviour: function() {
		$(this).each(function() { if ($(this).parent().hasClass("figures")) { $(this).mouseover(function() { ddrivetip($(this).attr("theTitle")); }).mouseout(function() { hideddrivetip(); }).mousedown(function() { hideddrivetip(); }); } });
	},
